    ...
    */
    ...
    class Buffer {
      ...
      public:
        ...
        */
        void emplace(char id, unsigned char value, size_t tid)
        {
    ...
    class ProfilerGuard {
        ...
        static void registerNewEvent(char id, unsigned char value, size_t tid)
        {
      ...
      public:
        ...
        ProfilerGuard(char id, char value)
            : _id(id),
